...
//--------------------------
// Port direct pin 2 -> PORTE[4] 000$0000
// !!! ARDUINO IDE 1.18.6 !!! 
...
// COM INTERRUPCAO POR BORDA DE DESCIDA EM PIN 2
...
// Aloca 1300 espaços para char (buffer de recebimento) para evitar multiplos Serial.print byte a byte
// Valor máximo devido a memória do emissor
...
int bytesReceivedAmount; // Quantidade de bytes recebidos até o momento
...
int finishedTransmissions; // Quantidade de transmissões realizadas
...
void setup() {
    ...
    // E7~E2.TX.RX
    DDRE = DDRE & ~(B00010000); // inputs e outputs; pin 2 DIGITAL D2 (PORTA E4) input
    ...
    // Com prescaler de 8
    // 16000000 Hz/8 = 2000000 Hz -> Periodo de 0.5u
    // 2000000 Hz/625 (contar até 625) = 3200 Hz -> Periodo de 312.5u
...
// Interrupção externa (FALLING EDGE) em pin 2
ISR(INT4_vect) {      
    ...
    // Com base, em TCNT1, para amostragem no ponto médio do bit
    initialdelay = 1;
